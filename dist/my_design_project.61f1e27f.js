...
})({"iIWTG":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "0df04c8561f1e27f";
"use strict";
...
(()=>{
    ...
    const closeModalOnOutsideClick = (event)=>{
        if (event.target.classList.contains("modal") || event.target.classList.contains("login") || event.target.classList.contains("review") || event.target.classList.contains("buynow") || event.target.classList.contains("buynow2") || event.target.classList.contains("subscribe") || event.target.classList.contains("signup")) event.target.classList.add("is-hidden");
    };
...
},{}]},["iIWTG","jJ31c"], "jJ31c", "parcelRequireb23e", {})

//# sourceMappingURL=my_design_project.61f1e27f.js.map
